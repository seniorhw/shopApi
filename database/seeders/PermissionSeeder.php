...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ['name' => 'good.index', 'cn_name' => '商品列表', 'guard_name' => 'api'],
            ['name' => 'good.store', 'cn_name' => '商品添加', 'guard_name' => 'api'],
            ['name' => 'good.update', 'cn_name' => '商品更新', 'guard_name' => 'api'],
            ...
            // 轮播图管理
            ['name' => 'slide.seq', 'cn_name' => '轮播排序', 'guard_name' => 'api'],
            ['name' => 'slides.index', 'cn_name' => '轮播列表', 'guard_name' => 'api'],
            ['name' => 'slide.store', 'cn_name' => '轮播添加', 'guard_name' => 'api'],
            ['name' => 'slide.show', 'cn_name' => '轮播详情', 'guard_name' => 'api'],
            ['name' => 'slide.update', 'cn_name' => '轮播更新', 'guard_name' => 'api'],
            ['name' => 'slide.destroy', 'cn_name' => '轮播删除', 'guard_name' => 'api'],
            ['name' => 'slide.status', 'cn_name' => '轮播禁用和启用', 'guard_name' => 'api'],
        ...
        //添加角色
        $role = Role::create(['name'=>'superadmin','cn_name'=>'超级管理员','guard_name'=>'api']);
        //为角色添加权限
